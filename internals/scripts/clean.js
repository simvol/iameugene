...
mkdir('-p', 'app/containers/MainPage');
...
cp('internals/templates/MainPage/MainPage.js', 'app/containers/MainPage/index.js');
cp('internals/templates/MainPage/messages.js', 'app/containers/MainPage/messages.js');
